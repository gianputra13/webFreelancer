    ...
    <div class="text-serv-bg">
        ...
        <div class="flex items-center pt-8 pl-5 space-x-2 border-t border-gray-100">
            ...
            @if (auth()->user()->detail_user()->first()->photo != null)
                <img src="{{ url(Storage::url(auth()->user()->detail_user()->first()->photo)) }}" alt="" class="object-cover object-center mr-1 rounded-full w-14 h-14" loading="lazy">
        ...
        <ul class="mt-6">
            <li class="relative px-6 py-3">
                @if (
                    request()->is('member/dashboard') || request()->is('member/dashboard/*') || request()->is('member/dashboard/*') || request()->is('member/*/dashboard') || request()->is('member/*/dashboard/*')
                )
        ...
        <ul>
            <li class="relative px-6 py-3">
                ...
                @if (
                    request()->is('member/service') || request()->is('member/service/*') || request()->is('member/service/*') || request()->is('member/*/service') || request()->is('member/*/service/*')
                )
                    <span class="absolute inset-y-0 left-0 w-1 rounded-tr-lg rounded-br-lg bg-serv-bg" aria-hidden="true"></span>
            ...
            <li class="relative px-6 py-3">
                ...
                @if (
                    request()->is('member/request') || request()->is('member/request/*') || request()->is('member/request/*') || request()->is('member/*/request') || request()->is('member/*/request/*')
                )
                    <span class="absolute inset-y-0 left-0 w-1 rounded-tr-lg rounded-br-lg bg-serv-bg" aria-hidden="true"></span>
                ...
                <a class="inline-flex items-center w-full text-sm font-light transition-colors duration-150 hover:text-gray-800" href="{{ route('member.request.index') }}">
                    ...
                    <span class="inline-flex items-center justify-center px-3 py-2 ml-auto text-xs font-bold leading-none text-green-500 rounded-full bg-serv-green-badge">{{ auth()->user()->pesan_buyer()->count() }}</span>
            ...
            <li class="relative px-6 py-3">
                ...
                @if (
                    request()->is('member/order') || request()->is('member/order/*') || request()->is('member/order/*') || request()->is('member/*/order') || request()->is('member/*/order/*')
                )
                    <span class="absolute inset-y-0 left-0 w-1 rounded-tr-lg rounded-br-lg bg-serv-bg" aria-hidden="true"></span>
                ...
                <a class="inline-flex items-center w-full text-sm font-light transition-colors duration-150 hover:text-gray-800" href="{{ route('member.order.index') }}">
                    ...
                    <span class="inline-flex items-center justify-center px-3 py-2 ml-auto text-xs font-bold leading-none text-green-500 rounded-full bg-serv-green-badge">{{ auth()->user()->pesan_freelancer()->count() }}</span>
            ...
            <li class="relative px-6 py-3">
                ...
                @if (
                    request()->is('member/profile') || request()->is('member/profile/*') || request()->is('member/profile/*') || request()->is('member/*/profile') || request()->is('member/*/profile/*')
                )
                    <span class="absolute inset-y-0 left-0 w-1 rounded-tr-lg rounded-br-lg bg-serv-bg" aria-hidden="true"></span>
