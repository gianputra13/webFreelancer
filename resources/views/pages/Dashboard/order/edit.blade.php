                                ...
                                <td class="px-1 py-5 text-sm w-2/8">
                                    <div class="flex items-center text-sm">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-400">{{ $order->user_buyer->detail_user->conatct_number ?? '' }}</p>
                                        </div>
                                    </div>
                                </td>
                        ...
                        <div class="m-auto text-center">
                            ...
                            <h2 class="mt-8 mb-1 text-2xl font-semibold text-gray-700">
                                ...
                                @if (isset($order->file))
                                 ...
                                 @else
                                    <p class="text-sm text-gray-400">Drag and Drop an file, or Browse</p>
                                @endif
                            ...
                            <div class="relative mt-0 md:mt-6">
                                ...
                                @if (isset($order->file))
                                <a href="{{ url(Storage::url($order->file ?? '')) }}" class="px-4 py-2 mt-2 text-left text-gray-700 rounded-xl bg-serv-hr" onclick="return confrim('Are you sure want to download this file ?')">Download File</a>
