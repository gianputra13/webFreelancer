                            ...
                            <div class="px-4 py-5 sm:p-6">
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="md:col-span-6 lg:col-span-3">
                                        ...
                                        <input placeholder="Website Developer" type="text" name="role" id="role" autocomplete="role" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $user->detail_user->role ?? '' }}" required>
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        @forelse ($experienceUser as $key => $item)
